...
def main():
    ...
    for i, data in enumerate(dataloader):
        ...
        if text_encoder is not None:
            model_kwargs['text_feat'] = text_encoder.encode(answers) * args.text_guidance_weight
        ...
        #     tensor2image(x, i)
        save_images_with_filenames(path[200],x0_filename,'/data/yjy_data/DDBM_GT_Unet/result_S2O_text_500_0.1')
