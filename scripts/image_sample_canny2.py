...
def main():
    ...
    output_images_dir = '/data/yjy_data/DDBM_GT_Unet/result_S2O_text_240000'
...
def create_argparser():
    defaults = dict(
        ...
        rho=7.0,
        steps=100,
        model_path="/data/yjy_data/DDBM_GT_Unet/logs_S2O_Canny_CAIB_MSFM_scene_text_encoder/ema_2_0.9999_240000.pt",
        CNW_path="/data/yjy_data/DDBM_GT_Unet/logs_S2O_Canny_CAIB_MSFM_scene_text_encoder/ema_1_0.9999_240000.pt",
